        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 max-w-7xl mx-auto">
          <div className="mt-10 mx-5 grid grid-cols-1">
            <article className="front-card p-5 flex flex-col justify-between">
              <img src={logo} alt="" className="w-0 lg:w-0" />
              <div>
          ...
          <div className="pt-8 px-5 pb-20">
            {!confirmed && (
              <form className="flex flex-col justify-center gap-8 max-w-lg lg:h-screen ">
                <div>
                  <label htmlFor="cardholder_name">Gamer's Name</label>
                  <input
                    type="text"
                    name="cardholder_name"
                    id="cardholder_name"
                    placeholder="Ayush Arora"
                    required
                    value={name}
                ...
                <div>
                  <label htmlFor="card_number">Gaming ID</label>
                  <input
                    type="text"
                    name="card_number"
                    id="card_number"
                    placeholder="e.g. AYU4  1234  PRO5  1589"
                    required
                    maxLength={16}
                    value={cardNumber
                      .replace(/\s/g, "")
    ...
    <>
      <div className="thank-you flex flex-col items-center justify-center lg:h-screen max-w-lg mx-auto">
        ...
        <p className="text-slate-400 text-center">
          Congrats !! Your gaming pass is ready !!
        </p>
        <button
